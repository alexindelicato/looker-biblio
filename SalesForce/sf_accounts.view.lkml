...
#   no longer being used - moving to annual contract value
  ...
  dimension: cohorts {
    type: string
    sql: case when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts"  and ${sf_net_arr_2019.net_arr_2019} >= 25000 then "Performing Arts in Canada - High ACV (25K+)"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts"  and ${sf_net_arr_2019.net_arr_2019} >= 25000 then "Performing Arts in Canada - High ACV (25K+)"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} >= 25000 then "Live Music & Other in Canada - High ACV (25K+)"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} < 25000 then "Performing Arts in Canada - Low ACV (<25K)"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} < 25000 then "Performing Arts in Canada - Low ACV (<25K)"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} < 25000 then "Live Music & Other in Canada - Low ACV (<25K)"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} < 25000 then "Live Music & Other in Canada - Low ACV (<25K)"
          ...
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} <= 5000 then "Performing Arts US (ARR <=5K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} <= 5000 then "Performing Arts US (ARR <=5K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} > 5000 and ${sf_net_arr_2019.net_arr_2019} < 30000 then "Performing Arts US (>=5K to <30K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} > 5000 and ${sf_net_arr_2019.net_arr_2019} < 30000 then "Performing Arts US (>=5K to <30K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} >= 30000 then "Performing Arts US (ARR >= 30K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} >= 30000 then "Performing Arts US (ARR >= 30K)"
          ...
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} < 5000 then "Other (low ACV <5K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} < 5000 then "Other (low ACV <5K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} >= 5000 then "Other (ARR >5K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} >= 5000 then "Other (ARR >5K)"
          ...
          when ${TABLE}.billing_country = "Canada"  and ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} < 25000 then "Performing Arts in Canada  - Low ACV (<25K)"
          when ${TABLE}.billing_country = "Canada" and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} >= 25000 then "Performing Arts in Canada - High ACV (25K+)"
          when ${TABLE}.billing_country IN ("Canada", "Jamaica") and ${TABLE}.Merchant_of_Record_c IS FALSE and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} < 25000 then "Live Music & Other non-US - Low ACV (<25K)"
          when ${TABLE}.billing_country IN ("Canada", "Jamaica") and ${TABLE}.Merchant_of_Record_c  and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} < 25000 then "Live Music & Other non-US - Low ACV (<25K)"
          when ${TABLE}.billing_country IN ("Canada", "Jamaica") and ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} >= 25000 then "Live Music & Other non-US - High ACV (25K+)"
          ...
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c IS FALSE and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} <= 5000 then "Performing Arts US (ARR <=5K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} <= 5000 then "Performing Arts US (ARR <=5K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c IS FALSE and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} > 5000 then "Performing Arts US (ARR 5K+)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c  and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} > 5000 then "Performing Arts US (ARR 5K+)"
          ...
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c IS FALSE and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019}<= 5000 then "Other US (low ACV <5K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c  and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} <= 5000 then "Other US (low ACV <5K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c IS FALSE and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} > 5000 then "Other US (ARR >5K)"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c  and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} > 5000 then "Other US (ARR >5K)" End;;
  }

  dimension: cohort_id {
    type: string
    sql: case when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts"  and ${sf_net_arr_2019.net_arr_2019} > 25000 then "1.1"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts"  and ${sf_net_arr_2019.net_arr_2019} > 25000 then "2.1"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} > 25000 then "1.2"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} < 25000 then "3.1"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} < 25000 then "4.1"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} < 25000 then "3.2"
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} < 25000 then "4.2"
          ...
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} <= 5000 then "7"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} <= 5000 then "8"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} > 5000 and ${sf_net_arr_2019.net_arr_2019} < 30000 then "9"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} > 5000 and ${sf_net_arr_2019.net_arr_2019} < 30000 then "10"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} >= 30000 then "11"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} >= 30000 then "12"
          ...
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} < 5000 then "17"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} < 5000 then "18"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  IN ("MMA", "MMA With Failover") and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} >= 5000 then "19"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.tl_gateway_c  = "VMA" and ${TABLE}.type = "Client - AudienceView Select" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} >= 5000 then "20"
          ...
          when ${TABLE}.billing_country = "Canada" and ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} < 25000 then "30"
          when ${TABLE}.billing_country = "Canada" and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} >= 25000 then "31"
          when ${TABLE}.billing_country IN ("Canada", "Jamaica") and ${TABLE}.Merchant_of_Record_c IS FALSE and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} <= 25000 then "32"
          when ${TABLE}.billing_country IN ("Canada", "Jamaica") and ${TABLE}.Merchant_of_Record_c  and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} <= 25000 then "32.1"
          when ${TABLE}.billing_country IN ("Canada", "Jamaica") and ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c IN ("Live Music", "Other") and ${sf_net_arr_2019.net_arr_2019} >= 25000 then "33"
          ...
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c IS FALSE and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} <= 5000 then "35"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} <= 5000 then "35.1"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c IS FALSE and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} > 5000 then "36"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c  and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Performing Arts" and ${sf_net_arr_2019.net_arr_2019} > 5000 then "36.1"
          ...
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c IS FALSE and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} <= 5000 then "38"
          when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c  and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} <= 5000 then "38.1"
           when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c IS FALSE and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} > 5000 then "39"
           when ${TABLE}.billing_country = "United States" and ${TABLE}.Merchant_of_Record_c and  ${TABLE}.type = "Client - CrowdTorch" and ${TABLE}.vertical_new_c = "Other" and ${sf_net_arr_2019.net_arr_2019} > 5000 then "39.1" END ;;
  }
