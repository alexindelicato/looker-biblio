view: pro_reporting_paysegment_detail {
    derived_table: {
      sql: SELECT
         order0_.client_id as order_payment_detail_segment_client_id,
         paymentseg1_.payment_date as order_payment_detail_segment_payment_date,
         paymentseg1_.amount as order_payment_detail_segment_payment_amount
...
coalesce(
  ...
  '1900-01-01 00:00:00.723'
    ...
    dimension: order_payment_detail_segment_client_id {
      type: number
      sql: ${TABLE}.order_payment_detail_segment_client_id ;;
    }

    dimension_group: order_payment_detail_segment_payment_date {
      type: time
      timeframes: [
        raw,
        time,
      ...
      sql: CAST(${TABLE}.order_payment_detail_segment_payment_date AS TIMESTAMP) ;;
    }

    dimension: order_payment_detail_segment_payment_amount {
      type: number
      sql: ${TABLE}.order_payment_detail_segment_payment_amount ;;
    }
  }
