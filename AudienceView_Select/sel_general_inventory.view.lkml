...
# FROM genBySec_inventory WHERE performanceID = '13eb90ecc2101fe9ae4d2e7c799b8b91';
  ...
  measure: sold_count {
    ...
    sql: case when ${sel_venues.venue_type} = 'General Admission' then ${ga_sold}
          ...
          END;;
   required_fields: [sel_venues.venue_type, sel_venues.admission, sel_reserved_inventory.sold, sel_general_inventory.sold]
  ...
  measure: inventory_count {
    ...
    sql: case when ${sel_venues.venue_type} = 'General Admission' then ${ga_inventory}
          ...
          END;;
   required_fields: [sel_venues.venue_type, sel_venues.admission,sel_general_inventory.sold,sel_general_inventory.inventory, sel_reserved_inventory.inventory, sel_general_inventory.sold]
  }
  ...
  measure: capacity_count {
    ...
    required_fields: [sel_venues.venue_type, sel_venues.admission, sel_general_inventory.sold, sel_reserved_inventory.sold, sel_reserved_inventory.held, sel_general_inventory.inventory,
            sel_reserved_inventory.inventory, sel_general_inventory.sold ]
  }
