view: sel_max_login {
    ...
    FROM SelectAWS_service.members  AS sel_members
    LEFT JOIN `fivetran-ovation-tix-warehouse.SelectAWS_service.agent_to_members`
       AS sel_agent_to_members ON sel_members.memberid=sel_agent_to_members.memberid
    LEFT JOIN `fivetran-ovation-tix-warehouse.SelectAWS_service.agents`
